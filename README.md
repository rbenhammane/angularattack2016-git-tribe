...
* `git clone git@github.com:rumblex/angularattack2016-git-tribe.git`

* `cd angularattack2016-git-tribe`
...
If you receive an error message `"You do not have permission to publish to git-tribe.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.
